    ...
    hamburgerContainer.innerHTML = `
      ...
      <div class="side-menu" id="sideMenu">
        ...
        <div class="side-menu-section">
          <div class="side-menu-section-title">※ 계정</div>
          <div class="side-menu-item" data-guest-only onclick="location.href='login.html'">
            <div class="side-menu-item-left">
              <span>로그인</span>
            </div>
            <span>›</span>
          </div>
          <div class="side-menu-item" data-guest-only onclick="location.href='signup.html'">
            <div class="side-menu-item-left">
              <span>회원가입</span>
            </div>
            <span>›</span>
          </div>
          <div class="side-menu-item" data-member-only hidden>
            <div class="side-menu-item-left">
          ...
          <div class="side-menu-item" data-member-only hidden onclick="twonLogout()">
            <div class="side-menu-item-left">
              <span>로그아웃</span>
            </div>
            <span>›</span>
...
window.updateSideMenuAuth = updateSideMenuAuth;
window.twonLogout = twonLogout;
